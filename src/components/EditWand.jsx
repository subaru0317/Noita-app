...
// const SpellSelector = ({ handleSpellSelect }) => {
//   return (
//     <div className="SpellAddButton">
//       {SpellList.map((spell) => (
//         <SpellAddButton spell={spell} key={spell.id} onAddToBoard={() => handleSpellSelect(spell)} />
//       ))}
//     </div>
//   );
// }
...
// const EditWand = ({ wandSpells, setWandSpells, handleReset, handleSpellSelect, handleSortSpells }) => {
//   return (
//     <>
//       <SpellSelector handleSpellSelect={handleSpellSelect} />
//       <SortableSpellWand wandSpells={wandSpells} setWandSpells={setWandSpells} />
//       <Button onClick={handleReset}>Wand Reset</Button>
//     </>
//   );
// };
